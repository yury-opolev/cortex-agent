...
/// <see cref="ISystemHub"/>) for readability and to let consumers depend on the
/// narrow slice they actually use. All methods still share a single SignalR hub
/// connection and route by method name, so the wire protocol is unchanged.
/// </remarks>
public interface IAgentHub : IChatHub, IMemoryHub, IHistoryHub, IVoiceIdHub, ICodingHub, ISystemHub
{
}
