...
/// This class lives in Contracts because both the Bridge and the Agent Host need
/// the same rules: the Bridge uses them when registering connector channels, and
/// the Agent Host uses them to recognise plugin channel IDs in <c>ChannelCatalog</c>.
/// </summary>
public static class PluginChannelId
{
