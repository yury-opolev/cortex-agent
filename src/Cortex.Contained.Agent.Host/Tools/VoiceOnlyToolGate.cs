...
/// <summary>
/// Hides the voice-only tool family (voice-enrollment tools) from any conversation that is not a
/// Discord voice session. Replaces the former hard-coded prefix check inside
/// <see cref="ToolRegistry"/>; voice visibility now lives behind the generic
